        ...
        <section id="education" class="bg-testing-color py-5 border-t-2 border-b-2 border-gray-400">
            <div class="grid grid-cols-1 sm:grid-cols-2">
                ...
                <div class="col-span-1 flex items-center justify-center mt-8 sm:mt-8 md:mt-2">
                    ...
                    I went to school in Myanmar at the Hmawbi Technology University and graduated with a Bachelor of Technology and a Bachelor of Engineering, with a concentration in Information Technology. 
            ...
            <div class="flex flex-col sm:flex-row justify-evenly items-center mt-7 pb-5">
                <div class="flex flex-col items-center text-center lg:w-1/5 sm:w-1/4 h-3/5 bg-edu-card-color p-4 sm:p-8 mb-20 sm:mb-0 
                    border border-pink-300 rounded-l-xl shadow-lg drop-shadow-xl">
                ...
                border border-pink-300 rounded-l-xl drop-shadow-xl shadow-lg">
                    <img class="w-14 sm:w-1/3 md:w-1/4 lg:w-14 xl:w-1/6" src={TULogo} alt="Logo"/>
